...
public class MyOrderDetail_Activity extends AppCompatActivity implements View.OnClickListener, Chat_Adapter.MyOrderAppOnclickListener {
...
//        userid = AppSession.getStringPreferences(Notification_Activity.this, Constants.USER_ID);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_cat:
                startActivity(new Intent(MyOrderDetail_Activity.this, AddToCart_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;

            case R.id.rl_notification:
                startActivity(new Intent(MyOrderDetail_Activity.this, Notification_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;
        }
    }
