...
public class All_Category_Adapter extends RecyclerView.Adapter<All_Category_Adapter.MyViewHolder> {
        ...
        public All_Category_Adapter(Context activity, ArrayList<HistoryData> List, MyOrderAppOnclickListener myOrderAppOnclickListener) {
            searchList = List;
            context = activity;
