...
import com.alpha.posapp.myorder_pkg.MyOrderDetail_Activity;
import com.alpha.posapp.notification_pkg.Notification_Activity;

import java.util.ArrayList;

public class Chat_Activity extends AppCompatActivity implements View.OnClickListener, Chat_Adapter.MyOrderAppOnclickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_rv);
//        userid = AppSession.getStringPreferences(Notification_Activity.this, Constants.USER_ID);
        ...
        tv_title.setText(R.string.chatlist);
    ...
    public void getVendoreList(){
        ...
        Chat_Adapter adapter = new Chat_Adapter(getApplicationContext(), chatList,this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_cat:
                startActivity(new Intent(Chat_Activity.this, AddToCart_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;

            case R.id.rl_notification:
                startActivity(new Intent(Chat_Activity.this, Notification_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;
