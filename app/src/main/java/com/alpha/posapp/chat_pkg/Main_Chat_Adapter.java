...
public class Main_Chat_Adapter extends RecyclerView.Adapter<Main_Chat_Adapter.MyViewHolder> {
        ...
        public Main_Chat_Adapter(Context activity, ArrayList<HistoryData> List, MyOrderAppOnclickListener myOrderAppOnclickListener) {
            searchList = List;
            context = activity;
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder  implements View.OnClickListener {
            ...
            public MyViewHolder(View view) {
                super(view);
                name_tv = view.findViewById(R.id.tvSenderChatId);
...
//                ll_box.setOnClickListener(this);
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_chat_row_personal, parent, false);
