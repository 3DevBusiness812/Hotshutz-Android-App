package com.alpha.posapp.payment_pkg;
...
public class PayNow_Activity extends AppCompatActivity implements View.OnClickListener {
...
//        userid = AppSession.getStringPreferences(Notification_Activity.this, Constants.USER_ID);
        ...
        tv_title.setText(R.string.selectpaymentmethode);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_cat:
                startActivity(new Intent(PayNow_Activity.this, AddToCart_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;

            case R.id.rl_notification:
                startActivity(new Intent(PayNow_Activity.this, Notification_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;
