...
public class FirstBannerAdapter extends PagerAdapter {
    ...
    public FirstBannerAdapter(Context context, List<HistoryData> datumList) {
        mContext = context;
    ...
    public Object instantiateItem(ViewGroup collection, int position) {
        ...
        ViewGroup layout = (ViewGroup) inflater.inflate(R.layout.first_banner_adapter, collection, false);
       ...
       /// Picasso.with(mContext).load(RetrofitClient.BANNER_URL + datumList.get(position).getSliderImage()).into(ivSlideId);
        ...
        Glide.with(mContext)
                .load(R.drawable.slider_img)
                .placeholder(R.drawable.slider_img)
                .fitCenter()
