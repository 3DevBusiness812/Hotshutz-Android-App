...
public class Home_Vendor_Adapter extends RecyclerView.Adapter<Home_Vendor_Adapter.MyViewHolder> {
        ...
        public Home_Vendor_Adapter(Context activity, ArrayList<HistoryData> List, MyOrderAppOnclickListener myOrderAppOnclickListener) {
            searchList = List;
            context = activity;
...
//                ll_box.setOnClickListener(this);
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_our_top_vendor_item, parent, false);
