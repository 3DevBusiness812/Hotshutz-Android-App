...
public class Notification_Activity extends AppCompatActivity implements View.OnClickListener, Notification_Adapter.MyOrderAppOnclickListener {
...
//        userid = AppSession.getStringPreferences(Notification_Activity.this, Constants.USER_ID);
    ...
    public void getVendoreList(){
        for(int i=0; i<3; i++){
            chatList.add(new HistoryData("Order Update"));
        }

        Notification_Adapter adapter = new Notification_Adapter(getApplicationContext(), chatList,this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_cat:
                startActivity(new Intent(Notification_Activity.this, AddToCart_Activity.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
                break;
